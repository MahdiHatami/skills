...
- **[tdd-android](./tdd-android/SKILL.md)** — Android/Kotlin sister to `tdd`. Adds test-pyramid discipline (JVM > Robolectric > Compose UI > instrumented), Flow/coroutines patterns with Turbine and virtual time, and MockK boundary rules.
